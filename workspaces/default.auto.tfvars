...
workspaces = {
  ...
  voltron-boundary = {
    ...
    org                   = "demo-land",
    working_directory     = "/boundary-worker",
    project_name          = "HASHISTACK",
    file_triggers_enabled = true
    trigger_patterns      = ["boundary-worker/**/*"],
    global_remote_state   = true,
    auto_apply            = true,
    vcs = {
      org      = "demoland",
  ...
  voltron-linux = {
    description           = "Voltron Linux Node"
    org                   = "demo-land",
    working_directory     = "/linux-node",
    project_name          = "HASHISTACK",
    file_triggers_enabled = true
    trigger_patterns      = ["linux-node/**/*"],
    global_remote_state   = true,
    auto_apply            = true,
    vcs = {
      org      = "demoland",
